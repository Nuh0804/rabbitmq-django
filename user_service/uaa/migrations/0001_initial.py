    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_with_role_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_role_name', to='uaa.userroles')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role_with_permission_permission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_role_with_permission_permission', to='uaa.userpermissions')),
                ('role_with_permission_role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_role_with_permission_role', to='uaa.userroles')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='permission_group', to='uaa.userpermissionsgroup'),
        ),
    ]
